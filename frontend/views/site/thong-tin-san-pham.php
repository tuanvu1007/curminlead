            ...
            <div class="col-md-8">
                <div id="content-single">
                    ...
                    <div role="tabpanel">
                    	...
                    	<?php
                    		$count = 0;
                    		foreach ($thongtin as $post ):
                    			$count++;
                    	?>
							<li role="presentation" class="<?php echo $count==1?'active':''?>">
                    			<a href="#<?php echo $count?>" aria-controls="<?php echo $count ?>" role="tab" data-toggle="tab"><?php echo $post->title; ?></a>
                    		</li>
                    	<?php
                    		endforeach;
                    	?>
                    	...
                    	<?php
                    		...
                    		foreach ($thongtin as $post ):
                    			$count++;
                    	?>
                    		<div role="tabpanel" class="tab-pane <?php echo $count==1?'active':''?>" id="<?php echo $count?>">
